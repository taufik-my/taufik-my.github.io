...
<div class="row mt-3 justify-content-center">
  <div class="col-auto">
    {% include figure.liquid path="https://taufikmuhamady.files.wordpress.com/2020/03/kaist.jpg?w=426&h=602" class="img-fluid rounded z-depth-1" zoomable=true style="max-width: 300px;" %}
  </div>
</div>
...
<div class="row mt-3 justify-content-center">
  <div class="col-auto">
    {% include figure.liquid path="https://taufikmuhamady.files.wordpress.com/2020/03/gks-und-2020-055_2_page-0001.jpg?" class="img-fluid rounded z-depth-1" zoomable=true style="max-width: 300px;" %}
  </div>
</div>
