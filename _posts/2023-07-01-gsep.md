...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="https://taufikmuhamady.files.wordpress.com/2020/03/gsep.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
  </div>
</div>
...
<div class="row mt-3 justify-content-center">
  <div class="col-auto">
    {% include figure.liquid path="https://taufikmuhamady.files.wordpress.com/2020/03/whatsapp-image-2020-03-22-at-3.47.16-pm.jpeg?w=388&h=560" class="img-fluid rounded z-depth-1" zoomable=true style="max-width: 300px;" %}
  </div>
</div>
